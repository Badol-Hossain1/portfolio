...
import logo from '../../public/my.jpeg'
        ...
        <div id='home'>
            <header className='flex items-center justify-between py-5 px-5 md:px-0' data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="300" data-aos-offset="0">
                ...
                <div className='flex items-center gap-4'>
                    {/* https://docs.google.com/document/d/1YPf0X20Xc96mQEwf1K9DGVmwDOtOAaDn/edit */}
                    <a href="https://drive.google.com/uc?export=download&id=1a8alnwFURNBmjaKySlPjHSWVLjaLBNku"  download type="button"  className="">
            ...
            <section className='flex justify-between md:my-20 my-10 items-center flex-col-reverse md:flex-row'>
                <div className='md:w-1/2 mx-10 md:mx-0 py-10 md:py-0' data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="300" data-aos-offset="0">
                    <h1 className={`md:text-6xl font-semibold text-white text-3xl`}>BADOL HOSSAIN</h1>
                    ...
                    <div className='flex gap-3 md:gap-5 py-6'>
                        <a target='_blank' href="https://www.facebook.com/badolhossain123"><FaFacebook className='md:text-2xl text-xl hover:scale-125 text-white hover:text-[#DC0DFE] dark:hover:text-[#38D9A9] duration-200 cursor-pointer' /></a>
                        <a target='_blank' href="https://github.com/Badol-Hossain1"><FaGithub className='md:text-2xl text-xl hover:scale-125 text-white hover:text-[#DC0DFE] dark:hover:text-[#38D9A9] duration-200 cursor-pointer' /></a>
                        <a target='_blank' href="https://www.linkedin.com/in/badol-hossain-416b59267/"><FaLinkedin className='md:text-2xl text-xl hover:scale-125 text-white hover:text-[#DC0DFE] dark:hover:text-[#38D9A9] duration-200 cursor-pointer' /></a>
                    </div>
                </div>
