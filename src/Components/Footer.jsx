    ...
    return (
        <div data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="100" data-aos-offset="0" className='py-5 z-50 mt-10 rounded-t-3xl md:rounded-t-full bg-gradient-to-r to-[#220D3E]  dark:to-[#202f53] dark:from-[#182340] dark:via-[#2c6779] via-[#3D0646] from-[#4c0457]'>
            <div className='flex gap-5 py-5 justify-center'>
                <Link target='_blank' to="https://github.com/Badol-Hossain1"><FaGithub className='text-2xl hover:scale-125 text-white hover:text-[#1ed2ff] dark:hover:text-[#38D9A9] duration-200 cursor-pointer' /></Link>
                <Link target='_blank' to="https://www.facebook.com/badolhossain123"><FaFacebook className='text-2xl hover:scale-125 text-white hover:text-[#1ed2ff] dark:hover:text-[#38D9A9] duration-200 cursor-pointer' /></Link>
